...
struct SaveBlock1
{
    ...
    /*0x3D88*/ u8 NuzlockeEncounterFlags[9]; //tx_randomizer_and_challenges
        ...
        // Counts revives SPENT, not remaining, so that a save written before this
        // field existed reads 0 and correctly means "full allowance unspent".
        u8 tx_Nuzlocke_RevivesUsed:4; //tx_randomizer_and_challenges
};
