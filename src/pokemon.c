...
{
    // Must be initialized: the Chaos branch below passes it to RandomSeededModulo
    // before it is ever assigned. RandomSeededModulo replaces the value with
    // Random() when Chaos is set, so 0 preserves the intended behaviour.
    u16 species = 0;
